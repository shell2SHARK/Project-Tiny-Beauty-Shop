...
public class EquipItens : MonoBehaviour
{
   ...
   [System.Serializable]
    public class ChangeItens
    {
        ...
        // identify where the character is looking
        [Space(15)]
        [Header("Identify where the character is looking:")]
        public string facedDirection = "Front";
        ...
        public void SetHat(string itemName)
        {
            ...
            ChangeBodySprite(facedDirection);
        }
